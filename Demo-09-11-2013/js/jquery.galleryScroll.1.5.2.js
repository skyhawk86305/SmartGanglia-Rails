...
jQuery.fn.galleryScroll = function(_options){
	...
	return this.each(function(){
        ...
        if (_options.startPos)
        {
            showSlide(_options.startPos);
        }
		...
		jQuery.fn.galleryScroll.numListActive = function(_marginEl, _slideNum, _width, _section){
				...
				if (_slideNum) {
//added to higlight initial
				  $('.f0').css('background-color','#eaeaea');
				$('.f1264').css('background-color','#fff');
				$('.f316').css('background-color','#fff');
				$('.f632').css('background-color','#fff');
				$('.f948').css('background-color','#fff');
			...
			if(_marginEl==0){
					...
					if(_marginEl==316){
						 $('.f316').css('background-color','#eaeaea');					
							 $('.f0').css('background-color','#fff');
							$('.f632').css('background-color','#fff');
							$('.f948').css('background-color','#fff');
							$('.f1264').css('background-color','#fff');
						...
						if(_marginEl==632){
						 $('.f632').css('background-color','#eaeaea');
						 $('.f0').css('background-color','#fff');
							$('.f316').css('background-color','#fff');
							$('.f948').css('background-color','#fff');
							$('.f1264').css('background-color','#fff');
					...
					if(_marginEl==948){
						 $('.f948').css('background-color','#eaeaea');
						 $('.f0').css('background-color','#fff');
							$('.f316').css('background-color','#fff');
							$('.f632').css('background-color','#fff');
							$('.f1264').css('background-color','#fff');
					...
					if(_marginEl==1264){
						 $('.f1264').css('background-color','#eaeaea');
						 $('.f0').css('background-color','#fff');
							$('.f316').css('background-color','#fff');
							$('.f632').css('background-color','#fff');
							$('.f948').css('background-color','#fff');
